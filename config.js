...
const config = {
  ...
  STRIPE_ACCOUNT_CONNECTION_SUCCESS_URL: process.env.STRIPE_ACCOUNT_CONNECTION_SUCCESS_URL,
  STRIPE_ACCOUNT_CONNECTION_FAILURE_URL: process.env.STRIPE_ACCOUNT_CONNECTION_FAILURE_URL,
};
