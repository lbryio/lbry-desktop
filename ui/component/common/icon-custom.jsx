...
export const icons = {
  ...
  [ICONS.POPCORN]: (props: CustomProps) => (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M9.750 18.000 A2.250 2.250 0 1 0 14.250 18.000 A2.250 2.250 0 1 0 9.750 18.000 Z" />
      <path d="M2.250 18.000 A2.250 2.250 0 1 0 6.750 18.000 A2.250 2.250 0 1 0 2.250 18.000 Z" />
      <path d="M17.250 18.000 A2.250 2.250 0 1 0 21.750 18.000 A2.250 2.250 0 1 0 17.250 18.000 Z" />
      <path d="M22.761,23.25a4.581,4.581,0,0,0-7.133,0A4.76,4.76,0,0,0,12,21.547" />
      <path d="M1.239,23.25a4.581,4.581,0,0,1,7.133,0A4.76,4.76,0,0,1,12,21.547" />
      <path d="M13.500 9.000 A2.250 2.250 0 1 0 18.000 9.000 A2.250 2.250 0 1 0 13.500 9.000 Z" />
      <path d="M6.000 9.000 A2.250 2.250 0 1 0 10.500 9.000 A2.250 2.250 0 1 0 6.000 9.000 Z" />
      <path d="M18.1,13.094a4.672,4.672,0,0,0-2.68-.84" />
      <path d="M15.424,12.254a4.607,4.607,0,0,0-2.488.724" />
      <path d="M10.659,12.978a4.6,4.6,0,0,0-4.9,0" />
      <path d="M2.218,14.25h-.49a.971.971,0,0,1-.978-.964V1.714A.971.971,0,0,1,1.728.75H22.272a.971.971,0,0,1,.978.964V13.286a.971.971,0,0,1-.978.964h-.489" />
    </svg>
  ),
};
