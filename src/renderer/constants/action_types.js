...
// Uploads
export const SPEECH_UPLOAD_BEGIN = "SPEECH_UPLOAD_BEGIN";
export const SPEECH_UPLOAD_SUCCESS = "SPEECH_UPLOAD_SUCCESS";
export const SPEECH_UPLOAD_ERROR = "SPEECH_UPLOAD_ERROR";
export const SPEECH_UPLOAD_RESET = "SPEECH_UPLOAD_RESET";
export const THUMBNAIL_SET_MANUAL_STATUS = "SPEECH_SET_MANUAL_STATUS";
export const THUMBNAIL_MANUAL_URL_UPDATE = "SPEECH_MANUAL_URL_UPDATE";
